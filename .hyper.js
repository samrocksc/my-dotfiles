...
// which will not automatically be merged into this file.  See https://hyper.is#cfg for all currently supported options.
...
module.exports = {
  ...
  // `~/.hyper_plugins/local/` and include it hcd ~/.hyper_plugins && npm installere
